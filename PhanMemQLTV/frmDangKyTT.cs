...
namespace PhanMemQLTV
{
    public partial class frmDangKyTT : Form
    {
        ...
        private void kTraDK()
        {
            ...
            int ktSDT;
            isNumberSDT = int.TryParse(txtSoDT.Text, out ktSDT);
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            {
                kTraDK();
                if (txtMaTT.Text.Length > 0 && txtTenTT.Text.Length > 0 && txtDiaChi.Text.Length > 0 && isNumberSDT == true && dtmNgaySinh.Text.Length > 0 && cboGioiTinh.Text.Length > 0 && txtTenTK.Text.Length > 0 && txtMK.Text.Length > 0)
                {
                    if (kq == 0)
                    {
                        try
                        {
                            string themdongsql = "insert into tblThuThu values ('" + txtMaTT.Text + "',N'" + txtTenTT.Text + "',N'" + cboGioiTinh.Text + "','" + dtmNgaySinh.Text + "','" + txtSoDT.Text + "',N'" + txtDiaChi.Text + "',N'" + txtGhiChu.Text + "','" + txtTenTK.Text + "','" + txtMK.Text + "')";
                            ketnoi(themdongsql);
